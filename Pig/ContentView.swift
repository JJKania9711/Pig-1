        ...
        NavigationView {
            ZStack {
                ...
                VStack {
                    ...
                    .font(Font.custom("Marker's Felt", size: 24))
                    Spacer()
                }
        ...
        ZStack {
            ...
            VStack {
                ...
                VStack (alignment: .leading) {
                    Text("In the game of pig, players take individual turns each turn, a player repeatedly rolls a single dice until either a pig is rolled or the player deicides to \"hold\".")
                        .padding()
                    Text("If the player rolls a pig, they score nothing, and it becomes the next player's turn.")
                        .padding()
                    Text("If thd player rolls any other number, it is added to their turn total, and the player's turn continues")
                        .padding()
